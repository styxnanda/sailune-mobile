...
cp build/app/outputs/flutter-apk/app-release.apk build/releases/sailune-v0.9.5-android.apk
(cd build/releases && shasum -a 256 sailune-v0.9.5-android.apk > SHA256SUMS)
